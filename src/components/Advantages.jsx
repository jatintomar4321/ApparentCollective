...
const WhatSetsUsApart = () => {
  return (
    <section className="bg-[#151515] border-b-[0.02rem] border-gray-500 w-full min-h-screen flex flex-col justify-center text-white py-28 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl  ">
        <h2 className="text-sm font-semibold text-gray-500 uppercase mb-4">Advantages</h2>
        <h3 className="text-5xl font-medium mb-12">What Sets Us Apart?</h3>
        ...
        <div className="grid gap-20 md:grid-cols-2 lg:grid-cols-2">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-[1.5rem] font-semibold mb-1">Design That Sells Anything</h4>
              <p className="text-[#FFFFFF99] font-normal  text-lg">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-[1.5rem] font-semibold mb-1">Cross-Browser Compatible</h4>
              <p className="text-[#FFFFFF99] font-normal text-lg">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-[1.5rem] font-semibold mb-1">Boundless Customization</h4>
              <p className="text-[#FFFFFF99] font-normal text-lg">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-[1.5rem] font-semibold mb-1">Round-the-Clock Support</h4>
              <p className="text-[#FFFFFF99] font-normal text-lg">
